...
`;
    ...
    describe('Bug fixes', () => {
        it('schema should validate additionalProp oneOf', () => __awaiter(void 0, void 0, void 0, function* () {
            const schema = {
                properties: {
                    env: {
            ...
            const result = yield parseSetup(content);
            chai_1.expect(result).to.be.not.empty;
            chai_1.expect(telemetry.messages).to.be.empty;
            chai_1.expect(result.length).to.eq(1);
            assert.deepStrictEqual(result[0].message, 'String does not match the pattern of "^\\$\\{\\{\\s*fromJSON\\(.*\\)\\s*\\}\\}$".');
        }));
        it('should handle not valid schema object', () => __awaiter(void 0, void 0, void 0, function* () {
            const schema = 'Foo';
            languageService.addSchema(testHelper_1.SCHEMA_ID, schema);
