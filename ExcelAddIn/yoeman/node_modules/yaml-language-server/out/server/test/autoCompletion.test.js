...
describe('Auto Completion Tests', () => {
    ...
    describe('YAML Completion Tests', function () {
        ...
        describe('Array Specific Tests', function () {
            ...
            it('Array autocomplete without word and autocompletion beside -', (done) => {
                ...
                completion
                    .then(function (result) {
                    assert.equal(result.items.length, 1);
                    assert.deepEqual(result.items[0], verifyError_1.createExpectedCompletion('name', ' name: ', 1, 3, 1, 3, 10, 2, {
                        documentation: '',
                    }));
                })
                    .then(done, done);
            ...
            it('Array of enum autocomplete without word on array symbol', (done) => {
                ...
                completion
                    .then(function (result) {
                    assert.equal(result.items.length, 1);
                    assert.deepEqual(result.items[0], verifyError_1.createExpectedCompletion('Test', ' Test', 1, 3, 1, 3, 12, 2, {
                        documentation: undefined,
                    }));
                })
                    .then(done, done);
        ...
        it('Array completion - should not suggest const', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(result.items.length).to.be.equal(0);
        }));
        it('Object in array with 4 space indentation check', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const content = 'rules:\n    -\n';
            const completion = yield parseSetup(content, 12);
    ...
    describe('Bug fixes', () => {
        ...
        it('auto completion based on the list indentation', () => __awaiter(void 0, void 0, void 0, function* () {
            languageService.addSchema(testHelper_1.SCHEMA_ID, {
                type: 'array',
                items: {
                    type: 'object',
            ...
            chai_1.expect(completion.items[0].insertText).eq('prop2: ');
        }));
        ...
        it('should follow $ref in additionalItems', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            chai_1.expect(completion.items).lengthOf(1);
            chai_1.expect(completion.items[0]).eql(verifyError_1.createExpectedCompletion('and', 'and', 2, 6, 2, 6, 12, vscode_languageserver_1.InsertTextFormat.Snippet, { documentation: undefined }));
        }));
        it('should follow $ref in additionalItems: extra space after cursor', () => __awaiter(void 0, void 0, void 0, function* () {
            languageService.addSchema(testHelper_1.SCHEMA_ID, {
                type: 'object',
                properties: {
                    test: {
            ...
            const completion = yield parseSetup(content, 20);
            chai_1.expect(completion.items).lengthOf(1);
            chai_1.expect(completion.items[0]).eql(verifyError_1.createExpectedCompletion('and', 'and', 2, 6, 2, 8, 12, vscode_languageserver_1.InsertTextFormat.Snippet, { documentation: undefined }));
        }));
    ...
    describe('Parent Completion', () => {
        ...
        it('Should suggest complete object skeleton', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const content = '';
            const result = yield parseSetup(content, content.length);
            chai_1.expect(result.items.length).equal(5);
            chai_1.expect(result.items[0]).to.deep.equal(verifyError_1.createExpectedCompletion('type', 'type: ${1|typeObj1,typeObj2|}', 0, 0, 0, 0, 10, 2, { documentation: '' }));
            chai_1.expect(result.items[1]).to.deep.equal(verifyError_1.createExpectedCompletion('Object1', 'type: typeObj1\noptions:\n  label: ', 0, 0, 0, 0, 7, 2, {
                documentation: {
                    kind: 'markdown',
                    value: 'Description1\n\n----\n\n```yaml\ntype: typeObj1\noptions:\n  label: \n```',
                },
            ...
            chai_1.expect(result.items[4]).to.deep.equal(verifyError_1.createExpectedCompletion('options', 'options:\n  description: ', 0, 0, 0, 0, 10, 2, { documentation: '' }));
        }));
        it('Should suggest complete object skeleton - array', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield parseSetup(content, content.length);
            chai_1.expect(result.items.length).equal(5);
            chai_1.expect(result.items[0]).to.deep.equal(verifyError_1.createExpectedCompletion('type', 'type: ${1|typeObj1,typeObj2|}', 0, 2, 0, 2, 10, 2, { documentation: '' }));
            chai_1.expect(result.items[1]).to.deep.equal(verifyError_1.createExpectedCompletion('Object1', 'type: typeObj1\n  options:\n    label: ', 0, 2, 0, 2, 7, 2, {
                documentation: {
                    kind: 'markdown',
                    value: 'Description1\n\n----\n\n```yaml\n  type: typeObj1\n  options:\n    label: \n```',
        ...
        it('Should not agregate suggested text from different schemas', () => __awaiter(void 0, void 0, void 0, function* () {
            const schema = {
                definitions: { obj1, obj2 },
                anyOf: [
                    {
            ...
            chai_1.expect(result.items[1]).to.deep.equal(result.items[3]);
        }));
        it('Should suggest rest of the parent object', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            chai_1.expect(result.items[1]).to.deep.equal(verifyError_1.createExpectedCompletion('Object1', 'options:\n  label: ', 1, 0, 1, 0, 7, 2, {
                documentation: {
                    kind: 'markdown',
                    value: 'Description1\n\n----\n\n```yaml\noptions:\n  label: \n```',
                },
        ...
        describe('Select parent skeleton first', () => {
            ...
            it('Should suggest complete object skeleton', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const content = '';
                const result = yield parseSetup(content, content.length);
                chai_1.expect(result.items.map((i) => i.label)).to.have.members(['Object1', 'obj2']);
            }));
            it('Should suggest complete object skeleton - nested', () => __awaiter(void 0, void 0, void 0, function* () {
                const schema = {
                    definitions: { obj1, obj2 },
                    properties: {
                        name: {
            ...
            it('Should suggest rest of the parent object', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const content = 'type: typeObj1\n';
                const result = yield parseSetup(content, content.length);
                chai_1.expect(result.items.map((i) => i.label)).to.have.members(['options', 'Object1']);
            }));
            it('Should suggest all feature when user is typing', () => __awaiter(void 0, void 0, void 0, function* () {
                const schema = {
                    definitions: { obj1 },
                    $ref: '#/definitions/obj1',
                };
                ...
                const content = 'ty';
                const result = yield parseSetup(content, content.length);
                chai_1.expect(result.items.map((i) => i.label)).to.have.members(['type', 'options', 'Object1']);
            }));
            it('Should suggest all properties in empty yaml with now required props', () => __awaiter(void 0, void 0, void 0, function* () {
                const schema = {
                    properties: {
                        fruit: {},
                        vegetable: {},
                ...
                const content = '';
                const result = yield parseSetup(content, content.length);
                chai_1.expect(result.items.map((i) => i.label)).to.have.members(['fruit', 'vegetable']);
            }));
        });
    });
});
