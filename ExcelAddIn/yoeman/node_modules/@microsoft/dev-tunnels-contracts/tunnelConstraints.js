...
(function (TunnelConstraints) {
     ...
     * Length of tunnel id.
     */
    TunnelConstraints.tunnelIdLength = 8;
    /**
     ...
     */
    TunnelConstraints.tunnelIdChars = '0123456789bcdfghjklmnpqrstvwxz';
    /**
     ...
     */
    TunnelConstraints.tunnelIdPattern = '[' + TunnelConstraints.tunnelIdChars + ']{8}';
    /**
     * Regular expression that can match or validate tunnel ID strings.
     *
     * Tunnel IDs are fixed-length and have a limited character set of numbers and
     * lowercase letters (minus vowels and y).
     */
    TunnelConstraints.tunnelIdRegex = new RegExp(TunnelConstraints.tunnelIdPattern);
    /**
     ...
     */
    TunnelConstraints.tagPattern = '[\\w-=]{1,50}';
    /**
     * Regular expression that can match or validate tunnel or port tags.
     */
    TunnelConstraints.tagRegex = new RegExp(TunnelConstraints.tagPattern);
    /**
...
})(TunnelConstraints || (TunnelConstraints = {}));
