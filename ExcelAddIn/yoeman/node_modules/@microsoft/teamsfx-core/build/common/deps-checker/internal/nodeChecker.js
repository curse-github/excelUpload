...
exports.ProjectNodeChecker = exports.LtsNodeChecker = exports.AzureNodeChecker = exports.SPFxNodeChecker = exports.NodeChecker = void 0;
...
class SPFxNodeChecker extends NodeChecker {
    constructor() {
        ...
        this._minErrorVersion = 15;
        this._maxErrorVersion = 17;
    }
    ...
    getVersionNotSupportedError(supportedVersions, version) {
        ...
        return new depsError_1.NodeNotSupportedError(message_1.Messages.NodeNotSupported()
            .split("@CurrentVersion")
            .join(version.version)
            .split("@SupportedVersions")
            .join(supportedVersionsString), helpLink_1.nodeNotSupportedForSPFxHelpLink);
    }
}
...
class AzureNodeChecker extends NodeChecker {
    ...
    getVersionNotSupportedError(supportedVersions, version) {
        ...
        return new depsError_1.NodeNotSupportedError(message_1.Messages.NodeNotSupported()
            ...
            .join(version.version)
            .split("@SupportedVersions")
            .join(supportedVersionsString), helpLink_1.nodeNotSupportedForAzureHelpLink);
    }
}
...
class ProjectNodeChecker extends NodeChecker {
    ...
    async getNodeNotSupportedHelpLink() {
        return helpLink_1.v3NodeNotSupportedHelpLink;
    }
