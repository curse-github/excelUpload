...
function isDownloadDirectoryEnabled() {
    ...
    try {
        if (isV3Enabled()) {
            ...
            if (!settingsPath || !fs.pathExistsSync(settingsPath)) {
                ...
                const v4SettingsPath = projectSettingsLoader_1.getProjectSettingPathV2(rootPath);
                if (!v4SettingsPath || !fs.pathExistsSync(v4SettingsPath)) {
                    return undefined;
                }
                const v4SettingsContent = fs.readJsonSync(v4SettingsPath);
                return {
                    projectId: (_a = v4SettingsContent === null || v4SettingsContent === void 0 ? void 0 : v4SettingsContent.projectId) !== null && _a !== void 0 ? _a : undefined,
                };
            }
            const settingsContent = fs.readFileSync(settingsPath, "utf-8");
            const settings = yaml_1.parse(settingsContent);
            return {
                projectId: (_b = settings === null || settings === void 0 ? void 0 : settings.projectId) !== null && _b !== void 0 ? _b : undefined,
            };
        }
        else {
            ...
            return {
                projectId: (_c = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.projectId) !== null && _c !== void 0 ? _c : undefined,
                isFromSample: (_d = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.isFromSample) !== null && _d !== void 0 ? _d : undefined,
                programmingLanguage: (_e = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.programmingLanguage) !== null && _e !== void 0 ? _e : undefined,
                hostType: (_g = (_f = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.solutionSettings) === null || _f === void 0 ? void 0 : _f.hostType) !== null && _g !== void 0 ? _g : undefined,
                isM365: (_h = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.isM365) !== null && _h !== void 0 ? _h : false,
            };
        }
    }
    catch (_j) {
...
async function listDevTunnels(token) {
    try {
        const tunnelManagementClientImpl = new dev_tunnels_management_1.TunnelManagementHttpClient(TunnelManagementUserAgent, async () => {
