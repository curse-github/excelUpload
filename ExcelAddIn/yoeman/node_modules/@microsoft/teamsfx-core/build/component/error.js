...
exports.InvalidFeature = exports.FindFunctionAppError = exports.ResourceNotFoundError = exports.PackDirectoryExistenceError = exports.CheckThrowSomethingMissing = exports.PreconditionError = exports.invalidProjectSettings = exports.BadComponent = void 0;
...
class PreconditionError extends teamsfx_api_1.UserError {
    constructor(source, messages, suggestions) {
        const msgWithSuggestions = messages_1.concatErrorMessageWithSuggestions(messages, suggestions);
...
class PackDirectoryExistenceError extends teamsfx_api_1.UserError {
    constructor(source) {
        const msgWithSuggestions = messages_1.concatErrorMessageWithSuggestions(messages_1.ErrorMessage.SomethingIsNotExisting("pack directory"), [messages_1.ErrorMessage.RecreateTheProject]);
        super(source, new.target.name, msgWithSuggestions.default, msgWithSuggestions.localized);
    }
}
...
class ResourceNotFoundError extends teamsfx_api_1.SystemError {
    constructor(source, message) {
        super(source, new.target.name, localizeUtils_1.getDefaultString(message), localizeUtils_1.getLocalizedString(message));
    }
}
...
class InvalidFeature extends teamsfx_api_1.UserError {
    constructor() {
        super({
            source: "fx",
            message: localizeUtils_1.getDefaultString("error.InvalidFeature"),
            displayMessage: localizeUtils_1.getLocalizedString("error.InvalidFeature"),
        });
    }
}
