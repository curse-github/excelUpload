...
async function selectTemplateTag(getTags) {
    ...
    if ([constant_1.templateAlphaVersion, constant_1.templatePrereleaseVersion].includes(versionPattern)) {
...
async function unzip(zip, dstPath, nameReplaceFn, dataReplaceFn, relativePath) {
...
exports.escapeEmptyVariable = escapeEmptyVariable;
