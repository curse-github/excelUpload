...
class Generator {
    static getDefaultVariables(appName, safeProjectNameFromVS) {
        return {
            appName: appName,
            ProjectName: appName,
            SafeProjectName: safeProjectNameFromVS !== null && safeProjectNameFromVS !== void 0 ? safeProjectNameFromVS : utils_1.convertToAlphanumericOnly(appName),
        };
    }
    ...
    static async generateSample(ctx, destinationPath, sampleName, actionContext) {
        ...
        lodash_1.merge(actionContext === null || actionContext === void 0 ? void 0 : actionContext.telemetryProps, {
            ...
            [telemetry_1.TelemetryProperty.SampleDownloadDirectory]: tools_1.isDownloadDirectoryEnabled().toString(),
        });
        ...
        const generatorContext = {
            ...
            destination: destinationPath,
            logProvider: ctx.logProvider,
            url: tools_1.isDownloadDirectoryEnabled() ? sample.url : sample.link,
        ...
        await ((_b = actionContext === null || actionContext === void 0 ? void 0 : actionContext.progressBar) === null || _b === void 0 ? void 0 : _b.next(messages_1.ProgressMessages.generateSample(sampleName)));
        const actionSeq = tools_1.isDownloadDirectoryEnabled() ? generatorAction_1.DownloadDirectoryActionSeq : generatorAction_1.SampleActionSeq;
