import { ContextV3, FolderQuestion, FuncQuestion, FxError, Inputs, Json, MultiSelectQuestion, OptionItem, Platform, QTreeNode, Result, SingleSelectQuestion, TextInputQuestion, v2, v3 } from "@microsoft/teamsfx-api";
import { Runtime } from "./constants";
export declare function getQuestionsForProvisionV3(inputs: Inputs): Promise<Result<QTreeNode | undefined, FxError>>;
...
export declare function SelectEnvQuestion(): SingleSelectQuestion;
export declare function InitEditorVSCode(): OptionItem;
export declare function InitEditorVS(): OptionItem;
export declare function InitCapabilityTab(): OptionItem;
export declare function InitCapabilityBot(): OptionItem;
export declare function InitOptionYes(): OptionItem;
export declare function InitOptionNo(): OptionItem;
export declare function InitEditorQuestion(): SingleSelectQuestion;
export declare function InitCapabilityQuestion(): SingleSelectQuestion;
export declare function InitIsSPFxQuestion(): SingleSelectQuestion;
export declare function InitDebugProceedQuestion(): SingleSelectQuestion;
export declare function InitInfraProceedQuestion(): SingleSelectQuestion;
...
export declare function getQuestionsForUpdateTeamsApp(inputs: Inputs): Promise<Result<QTreeNode | undefined, FxError>>;
export declare function getQuestionsForPreviewWithManifest(inputs: Inputs): Promise<Result<QTreeNode | undefined, FxError>>;
