...
function spfxFolderQuestion() {
    return {
        type: "folder",
        name: constants_2.SPFxQuestionNames.SPFxFolder,
        ...
        default: (inputs) => {
            return path_1.default.join(inputs.projectPath, "src");
        },
    };
}
...
function getQuestionsForAddWebpart(inputs) {
    ...
    const localManifestFile = question_2.selectTeamsAppManifestQuestion(inputs, true);
...
exports.getQuestionsForValidateManifest = getQuestionsForValidateManifest;
async function getQuestionsForValidateAppPackage(inputs) {
    const group = new teamsfx_api_1.QTreeNode({ type: "group" });
    // App package path node
    const teamsAppSelectNode = new teamsfx_api_1.QTreeNode(question_2.selectTeamsAppPackageQuestion());
    group.addChild(teamsAppSelectNode);
    return teamsfx_api_1.ok(group);
}
exports.getQuestionsForValidateAppPackage = getQuestionsForValidateAppPackage;
async function getQuestionsForCreateAppPackage(inputs) {
    const group = new teamsfx_api_1.QTreeNode({ type: "group" });
    // Manifest path node
    const teamsAppSelectNode = question_2.selectTeamsAppManifestQuestion(inputs);
    group.addChild(teamsAppSelectNode);
...
exports.getQuestionsForCreateAppPackage = getQuestionsForCreateAppPackage;
async function getQuestionsForUpdateTeamsApp(inputs) {
    const group = new teamsfx_api_1.QTreeNode({ type: "group" });
    // Manifest path node
    const teamsAppSelectNode = question_2.selectTeamsAppManifestQuestion(inputs);
    group.addChild(teamsAppSelectNode);
...
exports.getQuestionsForUpdateTeamsApp = getQuestionsForUpdateTeamsApp;
async function getQuestionsForPreviewWithManifest(inputs) {
    const group = new teamsfx_api_1.QTreeNode({ type: "group" });
    group.addChild(question_2.selectM365HostQuestion());
    group.addChild(question_2.selectTeamsAppManifestQuestion(inputs));
    return teamsfx_api_1.ok(group);
}
exports.getQuestionsForPreviewWithManifest = getQuestionsForPreviewWithManifest;
