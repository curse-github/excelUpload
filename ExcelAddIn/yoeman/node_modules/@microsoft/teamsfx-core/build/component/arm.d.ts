...
export declare function getResourceManagementClientForArmDeployment(azureAccountProvider: AzureAccountProvider, subscriptionId: string): Promise<ResourceManagementClient>;
export declare function generateResourceBaseName(appName: string, envName: string): string;
export declare function wrapGetDeploymentError(deployCtx: DeployContext, resourceGroupName: string, deploymentName: string, rawError: any): Promise<Result<any, FxError>>;
...
declare class Arm {
    ...
    wrapGetDeploymentError(deployCtx: DeployContext, resourceGroupName: string, deploymentName: string, rawError: any): Promise<Result<any, FxError>>;
    getDeploymentError(deployCtx: DeployContext, resourceGroupName: string, deploymentName: string): Promise<any>;
}
