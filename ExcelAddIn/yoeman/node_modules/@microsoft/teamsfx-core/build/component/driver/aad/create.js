...
let CreateAadAppDriver = class CreateAadAppDriver {
    ...
    async execute(args, context, outputEnvVarNames) {
        ...
        let outputs = new Map();
        try {
            (_a = context.logProvider) === null || _a === void 0 ? void 0 : _a.info(localizeUtils_1.getLocalizedString(constants_2.logMessageKeys.startExecuteDriver, actionName));
            ...
            if (!aadAppState.clientId) {
                (_b = context.logProvider) === null || _b === void 0 ? void 0 : _b.info(localizeUtils_1.getLocalizedString(constants_2.logMessageKeys.startCreateAadApp, outputEnvVarNames.get(createAadAppOutput_1.OutputKeys.clientId)));
                ...
                (_d = context.logProvider) === null || _d === void 0 ? void 0 : _d.info(localizeUtils_1.getLocalizedString(constants_2.logMessageKeys.skipCreateAadApp, outputEnvVarNames.get(createAadAppOutput_1.OutputKeys.clientId)));
            }
            if (args.generateClientSecret) {
                if (!aadAppState.clientSecret) {
                    (_e = context.logProvider) === null || _e === void 0 ? void 0 : _e.info(localizeUtils_1.getLocalizedString(constants_2.logMessageKeys.startGenerateClientSecret, outputEnvVarNames.get(createAadAppOutput_1.OutputKeys.clientSecret)));
                    ...
                    const summary = localizeUtils_1.getLocalizedString(constants_2.logMessageKeys.successGenerateClientSecret, aadAppState.objectId);
                    (_f = context.logProvider) === null || _f === void 0 ? void 0 : _f.info(summary);
                    summaries.push(summary);
                }
                else {
                    (_g = context.logProvider) === null || _g === void 0 ? void 0 : _g.info(localizeUtils_1.getLocalizedString(constants_2.logMessageKeys.skipCreateAadApp, outputEnvVarNames.get(createAadAppOutput_1.OutputKeys.clientSecret)));
                }
            }
            (_h = context.logProvider) === null || _h === void 0 ? void 0 : _h.info(localizeUtils_1.getLocalizedString(constants_2.logMessageKeys.successExecuteDriver, actionName));
            return {
            ...
            if (error instanceof teamsfx_api_1.UserError || error instanceof teamsfx_api_1.SystemError) {
                (_j = context.logProvider) === null || _j === void 0 ? void 0 : _j.error(localizeUtils_1.getLocalizedString(constants_2.logMessageKeys.failExecuteDriver, actionName, error.displayMessage));
                return {
            ...
            if (axios_1.default.isAxiosError(error)) {
                ...
                (_k = context.logProvider) === null || _k === void 0 ? void 0 : _k.error(localizeUtils_1.getLocalizedString(constants_2.logMessageKeys.failExecuteDriver, actionName, message));
                if (error.response.status >= 400 && error.response.status < 500) {
                    return {
                        result: teamsfx_api_1.err(new common_1.UnhandledUserError(new Error(message), actionName, helpLink)),
                        summaries: summaries,
                    };
                }
                else {
                    return {
                        result: teamsfx_api_1.err(new common_1.UnhandledError(new Error(message), actionName)),
                        summaries: summaries,
                    };
                }
            }
...
tslib_1.__decorate([
    lib_1.hooks([
        ...
        updateProgress_1.updateProgress(localizeUtils_1.getLocalizedString("driver.aadApp.progressBar.createAadAppTitle")),
    ]),
