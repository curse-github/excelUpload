...
let PublishAppPackageDriver = class PublishAppPackageDriver {
    ...
    async publish(args, context, outputEnvVarNames) {
        ...
        if (!(await fs_extra_1.default.pathExists(appPackagePath))) {
            return teamsfx_api_1.err(new common_2.FileNotFoundError(actionName, appPackagePath, "https://aka.ms/teamsfx-actions/teamsapp-publish"));
        }
        ...
        if (!manifestFile) {
            return teamsfx_api_1.err(new common_2.FileNotFoundError(actionName, constants_1.Constants.MANIFEST_FILE, "https://aka.ms/teamsfx-actions/teamsapp-publish"));
        }
    ...
    validateArgs(args) {
        ...
        if (invalidParams.length > 0) {
            return teamsfx_api_1.err(new common_2.InvalidActionInputError(actionName, invalidParams, "https://aka.ms/teamsfx-actions/teamsapp-publish"));
        }
        else {
...
tslib_1.__decorate([
    lib_1.hooks([
        ...
        updateProgress_1.updateProgress(localizeUtils_1.getLocalizedString("driver.teamsApp.progressBar.publishTeamsAppStep2.2")),
    ]),
