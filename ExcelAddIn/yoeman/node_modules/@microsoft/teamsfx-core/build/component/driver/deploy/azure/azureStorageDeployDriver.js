...
class AzureStorageDeployDriverImpl extends azureDeployImpl_1.AzureDeployImpl {
    ...
    async azureDeploy(args, azureResource, azureCredential) {
        ...
        if (errorResponse) {
            throw new deploy_1.AzureStorageUploadFilesError(azureResource.instanceId, sourceFolder, errorResponse, this.helpLink);
        }
    ...
    static async createContainerClient(azureResource, azureCredential) {
        ...
        return await azureSdkErrorHandler_1.wrapAzureOperation(async () => {
            ...
            return container;
        }, (e) => new deploy_1.AzureStorageGetContainerError(azureResource.instanceId, deployConstant_1.DeployConstant.AZURE_STORAGE_CONTAINER_NAME, e), (e) => new deploy_1.AzureStorageGetContainerError(azureResource.instanceId, deployConstant_1.DeployConstant.AZURE_STORAGE_CONTAINER_NAME, e));
    }
    async deleteAllBlobs(client, storageName, logProvider) {
        ...
        const errorResponse = responses.find((res) => res.errorCode);
        if (errorResponse) {
            throw new deploy_1.AzureStorageClearBlobsError(storageName, errorResponse);
        }
    }
