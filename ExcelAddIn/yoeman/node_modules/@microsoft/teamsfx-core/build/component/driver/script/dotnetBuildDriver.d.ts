...
export declare class DotnetBuildDriver extends BaseBuildStepDriver {
...
export declare class DotnetBuildDriverImpl extends BaseBuildDriver {
    buildPrefix: string;
}
//# sourceMappingURL=dotnetBuildDriver.d.ts.map