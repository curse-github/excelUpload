...
exports.sendErrorTelemetryThenReturnError = exports.formattedDeploymentError = exports.wrapGetDeploymentError = exports.generateResourceBaseName = exports.getResourceManagementClientForArmDeployment = exports.getParameterJsonV3 = exports.updateAzureParameters = exports.copyParameterJson = exports.deployArmTemplatesV3 = exports.handleArmDeploymentError = exports.doDeployArmTemplatesV3 = exports.pollDeploymentStatus = exports.getRequiredOperation = void 0;
...
async function handleArmDeploymentError(error, deployCtx) {
    ...
    const result = await arm.wrapGetDeploymentError(deployCtx, deployCtx.resourceGroupName, deployCtx.deploymentName, error);
    if (result.isOk()) {
...
exports.getResourceManagementClientForArmDeployment = getResourceManagementClientForArmDeployment;
async function compileBicepToJson(bicepCommand, bicepOrchestrationFilePath, logger) {
    try {
        ...
        throw new arm_1.CompileBicepError(bicepOrchestrationFilePath, err);
    }
}
...
async function wrapGetDeploymentError(deployCtx, resourceGroupName, deploymentName, rawError) {
    try {
        const deploymentError = await arm.getDeploymentError(deployCtx, resourceGroupName, deploymentName);
...
class Arm {
    ...
    async wrapGetDeploymentError(deployCtx, resourceGroupName, deploymentName, rawError) {
        return await wrapGetDeploymentError(deployCtx, resourceGroupName, deploymentName, rawError);
    }
    async getDeploymentError(deployCtx, resourceGroupName, deploymentName) {
