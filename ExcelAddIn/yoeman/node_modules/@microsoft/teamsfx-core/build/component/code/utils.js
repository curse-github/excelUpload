...
const scriptDriver_1 = require("../driver/script/scriptDriver");
...
function execute(command, workingDir, logger, env) {
    return new Promise((resolve, reject) => {
        ...
        if (os_1.default.platform() === "win32") {
            workingDir = scriptDriver_1.capitalizeFirstLetter(path.resolve(workingDir !== null && workingDir !== void 0 ? workingDir : ""));
        }
