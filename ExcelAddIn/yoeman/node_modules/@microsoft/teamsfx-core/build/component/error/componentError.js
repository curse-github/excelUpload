...
exports.PrerequisiteError = exports.ExecuteCommandError = exports.ExternalApiCallError = exports.BaseComponentInnerError = void 0;
...
class BaseComponentInnerError extends Error {
    constructor(source, errorType, name, messageKey, messageParams, suggestionKey, detail, helpLink) {
        super(messageKey
            ? messageParams
    ...
    static unknownError(source, error) {
        return new BaseComponentInnerError(source, "SystemError", "UnknownError", "error.common.UnhandledError", [JSON.stringify(error)]);
    }
}
...
class ExecuteCommandError extends BaseComponentInnerError {
    constructor(source, name, messageKey, messageParams, error) {
        super(source, "UserError", name, messageKey, messageParams, ["plugins.bot.CheckCommandOutput", "suggestions.retryTheCurrentStep"], error);
    }
    static fromErrorOutput(source, commands, error) {
        return new ExecuteCommandError(source, "CommandExecutionError", "plugins.bot.RunFailedCommand", commands, typeof error === "string" ? error : JSON.stringify(error));
    }
}
exports.ExecuteCommandError = ExecuteCommandError;
/**
