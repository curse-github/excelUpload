...
export declare class BaseComponentInnerError extends Error {
    ...
    detail?: string;
    constructor(source: string, errorType: "UserError" | "SystemError", name: string, messageKey?: string, messageParams?: string[], suggestionKey?: string[], detail?: string, helpLink?: string);
    toFxError(): FxError;
    /**
...
export declare class ExecuteCommandError extends BaseComponentInnerError {
    constructor(source: string, name: string, messageKey: string, messageParams: string[], error: string);
