...
class BotDebugHandler {
    ...
    async registerBot() {
        ...
        try {
            ...
            try {
                await appStudioClient_1.AppStudioClient.createBotRegistration(tokenResult.value, botReg, false);
            }
            catch (e) {
                if (((_a = e.innerError) === null || _a === void 0 ? void 0 : _a.teamsfxUrlName) == constants_1.TeamsFxUrlNames[constants_3.APP_STUDIO_API_NAMES.CREATE_BOT] &&
