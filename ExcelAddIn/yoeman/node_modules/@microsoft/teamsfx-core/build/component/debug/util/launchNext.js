...
function debug(includeFrontend, includeBackend, includeBot, browserName, order) {
    ...
    return {
        ...
        configurations,
        preLaunchTask: local_1.TaskOverallLabel.NextDefault,
        presentation: {
            group: "all",
            order: order,
        },
...
function debugM365(includeFrontend, includeBackend, includeBot, hubName, hubOrder, browserName, order) {
    ...
    return {
        ...
        configurations,
        preLaunchTask: hubName === constants_1.HubName.teams ? local_1.TaskOverallLabel.NextDefault : local_1.TaskOverallLabel.NextM365,
        presentation: {
