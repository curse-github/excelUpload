...
function generateSpfxConfigurations() {
    ...
    const configurations = [
        ...
        },
        {
            ...
            type: "pwa-msedge",
            request: "launch",
            url: constants_1.LaunchUrl.outlookLocalTab,
            webRoot: "${workspaceRoot}/SPFx",
            sourceMaps: true,
            sourceMapPathOverrides: {
                "webpack:///.././src/*": "${webRoot}/src/*",
        ...
        },
        {
            ...
            type: "pwa-msedge",
            request: "launch",
            url: constants_1.LaunchUrl.officeLocalTab,
            webRoot: "${workspaceRoot}/SPFx",
            sourceMaps: true,
            sourceMapPathOverrides: {
                "webpack:///.././src/*": "${webRoot}/src/*",
...
function generateSpfxCompounds() {
    ...
    launchCompounds.push({
        ...
        preLaunchTask: constants_2.TaskOverallLabel.TransparentDefault,
        presentation: {
            group: "group1: Teams",
            order: edgeOrder,
        },
        ...
        preLaunchTask: constants_2.TaskOverallLabel.TransparentM365,
        presentation: {
