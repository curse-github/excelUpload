...
const constants_3 = require("../appManifest/constants");
...
let BotService = class BotService extends azureResource_1.AzureResource {
    ...
    async provision(context, inputs, actionContext) {
        ...
        // init bot state
        (_g = context.envInfo.state)[_h = constants_1.ComponentNames.TeamsBot] || (_g[_h] = {});
        ...
        try {
            ...
            if (((_f = e.innerError) === null || _f === void 0 ? void 0 : _f.teamsfxUrlName) == constants_2.TeamsFxUrlNames[constants_3.APP_STUDIO_API_NAMES.CREATE_BOT] &&
                hasBotIdInEnvBefore) {
