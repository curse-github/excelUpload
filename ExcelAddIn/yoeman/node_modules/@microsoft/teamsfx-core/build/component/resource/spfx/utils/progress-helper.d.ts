...
export declare class ProgressHelper {
    ...
    static startPreDeployProgressHandler(ui: UserInteraction | undefined): Promise<IProgressHandler | undefined>;
    static endAllHandlers(success: boolean): Promise<void>;
    static endPreDeployProgress(success: boolean): Promise<void>;
    static startDeployProgressHandler(ui: UserInteraction | undefined): Promise<IProgressHandler | undefined>;
    static endDeployProgress(success: boolean): Promise<void>;
    static startScaffoldProgressHandler(ui: UserInteraction | undefined, isAdd?: boolean): Promise<IProgressHandler | undefined>;
