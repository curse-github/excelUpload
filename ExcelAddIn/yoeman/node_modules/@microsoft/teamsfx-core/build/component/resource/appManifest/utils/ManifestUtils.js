...
class ManifestUtils {
    ...
    async _readAppManifest(manifestTemplatePath) {
        if (!(await fs_extra_1.default.pathExists(manifestTemplatePath))) {
            return teamsfx_api_1.err(new common_2.FileNotFoundError("teamsApp", manifestTemplatePath));
        }
    ...
    async getCapabilities(projectRoot) {
        ...
        return teamsfx_api_1.ok(this._getCapabilities(manifestRes.value));
    }
    async getManifest(projectPath, envInfo, ignoreEnvStateValueMissing, telemetryProps) {
        ...
        const hasFrontend = capabilities.includes("staticTab") || capabilities.includes("configurableTab");
        const tabEndpoint = (_a = envInfo.state[constants_3.ComponentNames.TeamsTab]) === null || _a === void 0 ? void 0 : _a.endpoint;
        ...
        if (tokens.length > 0) {
            return teamsfx_api_1.err(new common_2.MissingEnvironmentVariablesError("teamsApp", tokens.join(","), manifestTemplatePath));
        }
        ...
        if (isLocalDebug || ((_b = manifest.validDomains) === null || _b === void 0 ? void 0 : _b.length) === 0) {
            const validDomains = [];
            const tabEndpoint = (_c = envInfo.state[constants_3.ComponentNames.TeamsTab]) === null || _c === void 0 ? void 0 : _c.endpoint;
            const tabDomain = (_d = envInfo.state[constants_3.ComponentNames.TeamsTab]) === null || _d === void 0 ? void 0 : _d.domain;
            if (tabDomain) {
            ...
            const botId = (_e = envInfo.state[constants_3.ComponentNames.TeamsBot]) === null || _e === void 0 ? void 0 : _e.botId;
            const botDomain = ((_f = envInfo.state[constants_3.ComponentNames.TeamsBot]) === null || _f === void 0 ? void 0 : _f.validDomain) ||
                ((_g = envInfo.state[constants_3.ComponentNames.TeamsBot]) === null || _g === void 0 ? void 0 : _g.domain);
            if (botId) {
                if (!botDomain && !ignoreEnvStateValueMissing) {
                    return teamsfx_api_1.err(new common_2.MissingEnvironmentVariablesError("teamsApp", "validDomain", manifestTemplatePath));
                }
                else if (botDomain) {
    ...
    async getManifestV3(manifestTemplatePath, state, withEmptyCapabilities, generateIdIfNotResolved = true) {
        ...
        if (generateIdIfNotResolved) {
            ...
            teamsAppId = common_1.expandEnvironmentVariable(manifest.id);
            manifest.id = "";
        }
        ...
        const tokens = common_1.getEnvironmentVariables(resolvedManifestString);
        if (tokens.length > 0) {
            return teamsfx_api_1.err(new common_2.MissingEnvironmentVariablesError("teamsApp", tokens.join(","), manifestTemplatePath));
        }
