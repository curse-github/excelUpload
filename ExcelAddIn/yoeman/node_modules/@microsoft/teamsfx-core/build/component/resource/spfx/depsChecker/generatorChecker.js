...
const question_helper_1 = require("../utils/question-helper");
const name = constants_1.Constants.GeneratorPackageName;
const supportedVersion = constants_1.Constants.SPFX_VERSION;
...
class GeneratorChecker {
    ...
    async isLatestInstalled() {
        ...
        try {
            const generatorVersion = await this.queryVersion();
            const latestGeneratorVersion = (_a = question_helper_1.PackageSelectOptionsHelper.getLatestSpGeneratorVersion()) !== null && _a !== void 0 ? _a : (await this.findLatestVersion(5));
