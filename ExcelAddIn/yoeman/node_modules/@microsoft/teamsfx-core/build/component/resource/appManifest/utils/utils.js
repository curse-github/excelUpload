...
exports.RetryHandler = exports.MeetingsContext = exports.CommandScope = exports.hasMeetingExtension = exports.getFeaturesFromAppDefinition = exports.containsUnsupportedFeature = exports.needBotCode = exports.isBotAndMessageExtension = exports.isMessageExtension = exports.isBot = exports.needTabCode = exports.needTabAndBotCode = exports.isGroupApp = exports.isPersonalApp = exports.renderTemplate = exports.getLocalAppName = exports.getCustomizedKeys = void 0;
...
exports.isBot = isBot;
function isMessageExtension(appDefinition) {
    return !!appDefinition.messagingExtensions && appDefinition.messagingExtensions.length > 0;
}
exports.isMessageExtension = isMessageExtension;
function isBotAndMessageExtension(appDefinition) {
    return isBot(appDefinition) && isMessageExtension(appDefinition);
}
exports.isBotAndMessageExtension = isBotAndMessageExtension;
...
const groupAppConfigured = (tab) => {
    ...
    if (tab.scopes) {
        tab.scopes = developerPortalScaffoldUtils_1.updateScope(tab.scopes);
    }
    const validGroupAppScope = lodash_1.includes(tab.scopes, CommandScope.GroupChat) || lodash_1.includes(tab.scopes, CommandScope.Team);
...
const meetingExtensionConfigured = (tab) => {
    ...
    const validMeetingScope = lodash_1.includes(tab.scopes, CommandScope.GroupChat);
