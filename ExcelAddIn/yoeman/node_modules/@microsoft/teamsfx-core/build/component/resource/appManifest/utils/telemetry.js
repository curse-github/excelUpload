...
class TelemetryUtils {
    ...
    static addCommonProperty(properties) {
        ...
        let tenantId;
        let teamsAppId;
        if (((_a = this.ctx.envInfo) === null || _a === void 0 ? void 0 : _a.state) instanceof Map) {
            tenantId = (_c = (_b = this.ctx.envInfo) === null || _b === void 0 ? void 0 : _b.state.get(constants_2.PluginNames.SOLUTION)) === null || _c === void 0 ? void 0 : _c.get(constants_2.REMOTE_TEAMS_APP_TENANT_ID);
            teamsAppId = (_e = (_d = this.ctx.envInfo) === null || _d === void 0 ? void 0 : _d.state.get(constants_2.PluginNames.APPST)) === null || _e === void 0 ? void 0 : _e.get(constants_1.Constants.TEAMS_APP_ID);
        }
        else {
            tenantId = (_f = this.ctx.envInfo) === null || _f === void 0 ? void 0 : _f.state[constants_2.PluginNames.SOLUTION].teamsAppTenantId;
            teamsAppId = (_g = this.ctx.envInfo) === null || _g === void 0 ? void 0 : _g.state[constants_2.ComponentNames.AppManifest].teamsAppId;
        }
        if (tenantId) {
