...
export declare class ManifestUtils {
    ...
    getManifestV3(manifestTemplatePath: string, state: any, withEmptyCapabilities?: boolean, generateIdIfNotResolved?: boolean): Promise<Result<TeamsAppManifest, FxError>>;
