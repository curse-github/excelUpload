...
AppStudioError.DeveloperPortalAPIFailedError = {
    name: "DeveloperPortalAPIFailed",
    message: (e, correlationId, requestPath, apiName, extraData) => [
        localizeUtils_1.getDefaultString("error.appstudio.apiFailed.telemetry", e.name, e.message, apiName, correlationId, extraData),
        localizeUtils_1.getLocalizedString("error.appstudio.apiFailed"),
    ],
};
