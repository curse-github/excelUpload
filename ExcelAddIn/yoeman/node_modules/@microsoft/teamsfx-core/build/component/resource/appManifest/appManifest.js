...
let AppManifest = class AppManifest {
    ...
    async listCollaborator(ctx, inputs, envInfo, m365TokenProvider, teamsAppIdV3) {
        ...
        try {
            ...
            if (!teamsAppId) {
                return teamsfx_api_1.err(new teamsfx_api_1.UserError(constants_2.Constants.PLUGIN_NAME, errors_1.AppStudioError.ListCollaboratorFailedError.name, localizeUtils_1.getLocalizedString("core.collaboration.error.failedToGetTeamsAppId", constants_2.Constants.TEAMS_APP_ID_ENV)));
            }
    ...
    async grantPermission(ctx, inputs, envInfo, m365TokenProvider, userInfo, teamsAppIdV3) {
        ...
        try {
            ...
            const teamsAppId = tools_1.isV3Enabled()
                ...
                : await this.getTeamsAppId(ctx, inputs, envInfo);
            if (!teamsAppId) {
                return teamsfx_api_1.err(new teamsfx_api_1.UserError(constants_2.Constants.PLUGIN_NAME, errors_1.AppStudioError.GrantPermissionFailedError.name, localizeUtils_1.getLocalizedString("core.collaboration.error.failedToGetTeamsAppId", constants_2.Constants.TEAMS_APP_ID_ENV)));
            }
            try {
    ...
    async checkPermission(ctx, inputs, envInfo, m365TokenProvider, userInfo, teamsAppIdV3) {
        ...
        try {
            ...
            const teamsAppId = tools_1.isV3Enabled()
                ...
                : await this.getTeamsAppId(ctx, inputs, envInfo);
            if (!teamsAppId) {
                return teamsfx_api_1.err(new teamsfx_api_1.UserError(constants_2.Constants.PLUGIN_NAME, errors_1.AppStudioError.CheckPermissionFailedError.name, localizeUtils_1.getLocalizedString("core.collaboration.error.failedToGetTeamsAppId", constants_2.Constants.TEAMS_APP_ID_ENV)));
            }
