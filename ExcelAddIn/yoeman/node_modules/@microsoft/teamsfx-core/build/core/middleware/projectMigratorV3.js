...
exports.updateGitignore = exports.checkActiveResourcePlugins = exports.generateApimPluginEnvContent = exports.checkapimPluginExists = exports.debugMigration = exports.userdataMigration = exports.statesMigration = exports.configsMigration = exports.ensureTrackingIdInGlobal = exports.generateLocalConfig = exports.popupMessage = exports.popupMessageNonmodal = exports.popupMessageModal = exports.showConfirmOnlyNotification = exports.showNonmodalNotification = exports.askUserConfirm = exports.showNotification = exports.azureParameterMigration = exports.manifestsMigration = exports.updateLaunchJson = exports.generateAppYml = exports.checkVersionForMigration = exports.migrate = exports.wrapRunMigration = exports.ProjectMigratorMWV3 = exports.moreInfoButton = exports.errorNames = exports.learnMoreLink = exports.TelemetryPropertyValue = exports.TelemetryPropertyKey = exports.Parameters = exports.Constants = void 0;
...
const constants_3 = require("../../component/debug/constants");
...
exports.TelemetryPropertyKey = {
    button: "button",
    mode: "mode",
    upgradeVersion: "upgrade-version",
    reason: "reason",
};
exports.TelemetryPropertyValue = {
    ok: "ok",
...
const migrationMessageButtons = [projectMigrator_1.upgradeButton, exports.moreInfoButton];
const subMigrations = [
    preMigration,
    manifestsMigration,
    generateAppYml,
...
const ProjectMigratorMWV3 = async (ctx, next) => {
    ...
    if (isUpgradeable) {
        ...
        if (isRunMigration) {
            const isNonmodalMessage = v3MigrationUtils_1.getParameterFromCxt(ctx, exports.Parameters.isNonmodalMessage);
...
async function wrapRunMigration(context, exec) {
    try {
        telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorMigrateStart, {
            [exports.TelemetryPropertyKey.upgradeVersion]: exports.TelemetryPropertyValue.upgradeVersion,
        });
        await exec(context);
        await showSummaryReport(context);
        telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorMigrate, context.telemetryProperties);
    }
    catch (error) {
        let fxError;
        ...
        telemetry_1.sendTelemetryErrorEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorError, fxError, context.telemetryProperties);
...
async function updateLaunchJson(context) {
    ...
    if (await fs.pathExists(launchJsonPath)) {
        ...
        if (oldProjectSettings.isM365) {
            ...
            jsonObject.configurations.push(debugV3MigrationUtils_1.launchRemote(constants_3.HubName.teams, constants_3.LaunchBrowser.edge, "Edge", constants_3.LaunchUrl.teamsRemote, 1));
            jsonObject.configurations.push(debugV3MigrationUtils_1.launchRemote(constants_3.HubName.teams, constants_3.LaunchBrowser.chrome, "Chrome", constants_3.LaunchUrl.teamsRemote, 1));
            if (debugV3MigrationUtils_1.OldProjectSettingsHelper.includeTab(oldProjectSettings)) {
                jsonObject.configurations.push(debugV3MigrationUtils_1.launchRemote(constants_3.HubName.outlook, constants_3.LaunchBrowser.edge, "Edge", constants_3.LaunchUrl.outlookRemoteTab, 2));
                jsonObject.configurations.push(debugV3MigrationUtils_1.launchRemote(constants_3.HubName.outlook, constants_3.LaunchBrowser.chrome, "Chrome", constants_3.LaunchUrl.outlookRemoteTab, 2));
                jsonObject.configurations.push(debugV3MigrationUtils_1.launchRemote(constants_3.HubName.office, constants_3.LaunchBrowser.edge, "Edge", constants_3.LaunchUrl.officeRemoteTab, 3));
                jsonObject.configurations.push(debugV3MigrationUtils_1.launchRemote(constants_3.HubName.office, constants_3.LaunchBrowser.chrome, "Chrome", constants_3.LaunchUrl.officeRemoteTab, 3));
            }
            else if (debugV3MigrationUtils_1.OldProjectSettingsHelper.includeBot(oldProjectSettings)) {
                jsonObject.configurations.push(debugV3MigrationUtils_1.launchRemote(constants_3.HubName.outlook, constants_3.LaunchBrowser.edge, "Edge", constants_3.LaunchUrl.outlookRemoteBot, 2));
                jsonObject.configurations.push(debugV3MigrationUtils_1.launchRemote(constants_3.HubName.outlook, constants_3.LaunchBrowser.chrome, "Chrome", constants_3.LaunchUrl.outlookRemoteBot, 2));
            }
...
async function manifestsMigration(context) {
    ...
    const activeResourcePlugins = projectSettings.solutionSettings
...
async function showNotification(ctx, versionForMigration) {
    ...
    const confirmOnly = v3MigrationUtils_1.getParameterFromCxt(ctx, exports.Parameters.confirmOnly);
    if (confirmOnly) {
        return await showConfirmOnlyNotification(ctx);
    }
    const skipUserConfirm = v3MigrationUtils_1.getParameterFromCxt(ctx, exports.Parameters.skipUserConfirm);
    if (skipUserConfirm) {
        telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorNotification, {
            [exports.TelemetryPropertyKey.button]: exports.TelemetryPropertyValue.ok,
            [exports.TelemetryPropertyKey.upgradeVersion]: exports.TelemetryPropertyValue.upgradeVersion,
            [exports.TelemetryPropertyKey.mode]: exports.TelemetryPropertyValue.skipUserConfirm,
        });
        return true;
    }
...
async function askUserConfirm(ctx, versionForMigration) {
    ...
    do {
        ...
        if (answer === exports.moreInfoButton) {
            ...
            telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorNotification, {
                [exports.TelemetryPropertyKey.button]: exports.TelemetryPropertyValue.learnMore,
                [exports.TelemetryPropertyKey.upgradeVersion]: exports.TelemetryPropertyValue.upgradeVersion,
                [exports.TelemetryPropertyKey.mode]: exports.TelemetryPropertyValue.modal,
            });
        }
    } while (answer === exports.moreInfoButton);
    if (!answer || !migrationMessageButtons.includes(answer)) {
        telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorNotification, {
            [exports.TelemetryPropertyKey.button]: exports.TelemetryPropertyValue.cancel,
            [exports.TelemetryPropertyKey.upgradeVersion]: exports.TelemetryPropertyValue.upgradeVersion,
            [exports.TelemetryPropertyKey.mode]: exports.TelemetryPropertyValue.modal,
        });
...
async function showNonmodalNotification(ctx, versionForMigration) {
    ...
    if (answer === exports.moreInfoButton) {
        ...
        telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorNotification, {
            [exports.TelemetryPropertyKey.button]: exports.TelemetryPropertyValue.learnMore,
            [exports.TelemetryPropertyKey.upgradeVersion]: exports.TelemetryPropertyValue.upgradeVersion,
            [exports.TelemetryPropertyKey.mode]: exports.TelemetryPropertyValue.nonmodal,
        });
        return false;
    }
    else if (answer === projectMigrator_1.upgradeButton) {
        telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorNotification, {
            [exports.TelemetryPropertyKey.button]: exports.TelemetryPropertyValue.ok,
            [exports.TelemetryPropertyKey.upgradeVersion]: exports.TelemetryPropertyValue.upgradeVersion,
            [exports.TelemetryPropertyKey.mode]: exports.TelemetryPropertyValue.nonmodal,
...
exports.showNonmodalNotification = showNonmodalNotification;
async function showConfirmOnlyNotification(ctx) {
    ...
    if ((res === null || res === void 0 ? void 0 : res.isOk()) && res.value === "OK") {
        telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorNotification, {
            [exports.TelemetryPropertyKey.button]: exports.TelemetryPropertyValue.ok,
            [exports.TelemetryPropertyKey.upgradeVersion]: exports.TelemetryPropertyValue.upgradeVersion,
            [exports.TelemetryPropertyKey.mode]: exports.TelemetryPropertyValue.confirmOnly,
        });
        return true;
    }
    else {
...
async function ensureTrackingIdInGlobal(context) {
    ...
    globalVars_1.globalVars.trackingId = projectId; // set trackingId to globalVars
}
exports.ensureTrackingIdInGlobal = ensureTrackingIdInGlobal;
            ...
            if (fileName.startsWith("config.")) {
                ...
                if (fileNamesArray != null) {
                    ...
                    if (!(await context.fsPathExists(path.join(versionMetadata_1.MetadataV3.defaultEnvironmentFolder, exports.Constants.envFilePrefix + envName)))) {
                        ...
                        await context.fsWriteFile(path.join(versionMetadata_1.MetadataV3.defaultEnvironmentFolder, exports.Constants.envFilePrefix + envName), envName === "local" ? versionMetadata_1.MetadataV3.envFileLocalComment : versionMetadata_1.MetadataV3.envFileDevComment, exports.Constants.envWriteOption);
                    }
...
async function userdataMigration(context) {
    ...
    for (const stateFile of stateFiles) {
        ...
        if (envName) {
            ...
            await context.fsWriteFile(path.join(versionMetadata_1.MetadataV3.defaultEnvironmentFolder, envFileName), envData, exports.Constants.envWriteOption);
        }
    }
}
...
async function checkActiveResourcePlugins(projectPath) {
    try {
        ...
        if (projectSettings && solutionSettings && solutionSettings.activeResourcePlugins) {
            ...
            telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorPrecheckFailed, {
                [exports.TelemetryPropertyKey.upgradeVersion]: exports.TelemetryPropertyValue.upgradeVersion,
                [exports.TelemetryPropertyKey.reason]: "solutionSettings invalid",
            });
            return false;
        }
    }
        ...
        telemetry_1.sendTelemetryEvent(telemetry_1.Component.core, telemetry_1.TelemetryEvent.ProjectMigratorPrecheckFailed, {
            [exports.TelemetryPropertyKey.upgradeVersion]: exports.TelemetryPropertyValue.upgradeVersion,
            [exports.TelemetryPropertyKey.reason]: error.message,
        });
        return false;
    }
}
