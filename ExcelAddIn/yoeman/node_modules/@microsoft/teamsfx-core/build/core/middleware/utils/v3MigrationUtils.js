...
exports.buildEnvUserFileName = exports.buildEnvFileName = exports.buildFileName = exports.tryExtractEnvFromUserdata = exports.addMissingValidDomainForManifest = exports.isValidDomainForBotOutputKey = exports.updateAndSaveManifestForSpfx = exports.readAndConvertUserdata = exports.replaceAppIdUri = exports.generateAppIdUri = exports.getCapabilityStatus = exports.getToolkitVersionLink = exports.getParameterFromCxt = exports.getVersionState = exports.getTrackingIdFromPath = exports.getProjectVersionFromPath = exports.outputCancelMessage = exports.getDownloadLinkByVersionAndPlatform = exports.migrationNotificationMessage = exports.getProjectVersion = exports.jsonObjectNamesConvertV3 = exports.validDomain = exports.fsReadDirSync = exports.getTemplateFolderPath = exports.readBicepContent = exports.readJsonFile = void 0;
...
function jsonObjectNamesConvertV3(obj, prefix, parentKeyName, filetype, bicepContent) {
    ...
    if (lodash_1.isObject(obj)) {
        ...
        if (res.isOk()) {
            ...
            return res.value + "=" + stateValue + os_1.EOL;
        }
    }
    else
        return "";
...
async function readAndConvertUserdata(context, filePath, bicepContent) {
    let returnAnswer = "";
    const userdataContent = fs_extra_1.default.readFileSync(path_1.default.join(context.projectPath, filePath), "utf8");
