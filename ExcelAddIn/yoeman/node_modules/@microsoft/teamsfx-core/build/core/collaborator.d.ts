import { FxError, Result, TokenProvider, v2, v3, Json, Inputs, QTreeNode, ContextV3, M365TokenProvider } from "@microsoft/teamsfx-api";
...
export declare class CollaborationUtil {
    ...
    static parseManifestId(appId: string, inputs: Inputs): Promise<string | undefined>;
}
...
export declare function getQuestionsForListCollaborator(inputs: Inputs): Promise<Result<QTreeNode | undefined, FxError>>;
export declare function validateEnvQuestion(input: any, inputs?: Inputs): Promise<string | undefined>;
