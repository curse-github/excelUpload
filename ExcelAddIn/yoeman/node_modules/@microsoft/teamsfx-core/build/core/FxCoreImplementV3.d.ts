...
export declare class FxCoreV3Implement {
    ...
    addWebpart(inputs: Inputs, ctx?: CoreHookContext): Promise<Result<Void, FxError>>;
    ...
    preCheckYmlAndEnvForVS(inputs: Inputs, ctx?: CoreHookContext): Promise<Result<Void, FxError>>;
    ...
    validateManifest(inputs: Inputs, ctx?: CoreHookContext): Promise<Result<any, FxError>>;
    validateAppPackage(inputs: Inputs, ctx?: CoreHookContext): Promise<Result<any, FxError>>;
    createAppPackage(inputs: Inputs, ctx?: CoreHookContext): Promise<Result<any, FxError>>;
    previewWithManifest(inputs: Inputs, ctx?: CoreHookContext): Promise<Result<string, FxError>>;
}
