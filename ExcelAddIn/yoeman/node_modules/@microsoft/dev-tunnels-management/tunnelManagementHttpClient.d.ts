...
import { Tunnel, TunnelConnectionMode, TunnelEndpoint, TunnelPort, ClusterDetails, NamedRateStatus } from '@microsoft/dev-tunnels-contracts';
...
export declare class TunnelManagementHttpClient implements TunnelManagementClient {
     ...
     */
    constructor(userAgents: (ProductHeaderValue | string)[] | ProductHeaderValue | string, userTokenCallback?: () => Promise<string | null>, tunnelServiceUri?: string, httpsAgent?: https.Agent | undefined, adapter?: AxiosAdapter | undefined);
    ...
    deleteTunnelEndpoints(tunnel: Tunnel, hostId: string, connectionMode?: TunnelConnectionMode, options?: TunnelRequestOptions): Promise<boolean>;
     ...
     */
    protected sendTunnelRequest<TResult>(method: Method, tunnel: Tunnel, accessTokenScopes: string[], path?: string, query?: string, options?: TunnelRequestOptions, body?: object, allowNotFound?: boolean): Promise<NullableIfNotBoolean<TResult>>;
    /**
