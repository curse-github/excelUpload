...
exports.SupportedPlatform = exports.Context = exports.MeetingSurfaces = exports.Scopes2 = exports.AdditionalLanguages = exports.PositionAlign = exports.Extensions = exports.Authorization = exports.MeetingExtensionDefinition = exports.DefaultGroupCapability = exports.MosManifestDefaultInstallScope = exports.ConfigurableProperties = exports.SupportedChannelTypes = exports.Activities = exports.GraphConnector = exports.WebApplicationInfo = exports.DevicePermissions = exports.Permissions = exports.ScopeConstraints = exports.ComposeExtensions = exports.SubscriptionOffer = exports.Connectors = exports.Bots = exports.StaticTabs = exports.ConfigurableTabs = exports.Icons = exports.Description = exports.Name = exports.Developer = exports.LocalizationInfo = exports.MosManifestManifestVersion = exports.ExtensionCommonCustomControlMenuItemType = exports.ExtensionCommonCustomControlMenuType = exports.ExtensionCommonCustomGroupControlsItemType = exports.Position = exports.ExtensionRuntimesActionsItemType = exports.FormFactors = exports.Scopes = exports.Capabilities = exports.MosManifest = exports.ExtensionCommonIcon = exports.ExtensionCommonSuperToolTip = exports.ExtensionCommonCustomControlMenuItem = exports.ExtensionCommonCustomControlMenu = exports.ExtensionCommonCustomGroupControlsItem = exports.ExtensionCommonCustomGroup = exports.ExtensionRibbonsCustomTabGroupsItem = exports.ExtensionRibbonsArrayTabsItem = exports.ExtensionRuntimesActionsItem = exports.RequirementsExtensionElement = void 0;
exports.MenusType = exports.Options = exports.ResourceSpecificType = exports.Choices = exports.ParametersInputType = exports.TaskInfo2 = exports.Parameters2 = exports.Hide = exports.Prefer = exports.Menus = exports.Events = exports.Contexts = exports.RuntimesLifetime = exports.Code = exports.RuntimesType = exports.ResourceSpecific = exports.Value = exports.MessageHandlersType = exports.TaskInfo = exports.Parameters = exports.Context3 = exports.CommandsType = exports.Commands2 = exports.Scopes6 = exports.Team = exports.Alternates = exports.ContextMenus = exports.AutoRunEvents = exports.Ribbons = exports.Runtimes = exports.GetStartedMessages = exports.Permissions2 = exports.VideoFilters = exports.Scenes = exports.DefaultGroupCapabilityMeetings = exports.DefaultGroupCapabilityGroupchat = exports.DefaultGroupCapabilityTeam = exports.ActivityTypes = exports.GroupChats = exports.Teams = exports.MessageHandlers = exports.Commands = exports.Scopes5 = exports.CommandLists = exports.Scopes4 = exports.Configuration = exports.SupportedPlatform2 = exports.Context2 = exports.Scopes3 = exports.SupportedSharePointHosts = void 0;
exports.OptionsSendMode = exports.Choices2 = exports.Parameters2InputType = exports.CustomOfficeAddin = exports.StoreOfficeAddin = exports.XllCustomFunctions = exports.ComAddin = void 0;
...
class ExtensionCommonCustomGroupControlsItem {
    ...
    init(_data) {
        if (_data) {
            ...
            this.supertip = _data["supertip"] ? ExtensionCommonSuperToolTip.fromJS(_data["supertip"]) : undefined;
...
class MosManifest {
    ...
    init(_data) {
        if (_data) {
            ...
            this.scopeConstraints = _data["scopeConstraints"] ? ScopeConstraints.fromJS(_data["scopeConstraints"]) : undefined;
    ...
    toJSON(data) {
        ...
        data["scopeConstraints"] = this.scopeConstraints ? this.scopeConstraints.toJSON() : undefined;
...
})(FormFactors = exports.FormFactors || (exports.FormFactors = {}));
...
})(ExtensionRuntimesActionsItemType = exports.ExtensionRuntimesActionsItemType || (exports.ExtensionRuntimesActionsItemType = {}));
class Position {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
})(ExtensionCommonCustomGroupControlsItemType = exports.ExtensionCommonCustomGroupControlsItemType || (exports.ExtensionCommonCustomGroupControlsItemType = {}));
...
})(ExtensionCommonCustomControlMenuType = exports.ExtensionCommonCustomControlMenuType || (exports.ExtensionCommonCustomControlMenuType = {}));
...
})(ExtensionCommonCustomControlMenuItemType = exports.ExtensionCommonCustomControlMenuItemType || (exports.ExtensionCommonCustomControlMenuItemType = {}));
var MosManifestManifestVersion;
(function (MosManifestManifestVersion) {
    MosManifestManifestVersion["DevPreview"] = "devPreview";
    MosManifestManifestVersion["M365DevPreview"] = "m365DevPreview";
})(MosManifestManifestVersion = exports.MosManifestManifestVersion || (exports.MosManifestManifestVersion = {}));
...
class ConfigurableTabs {
    ...
    init(_data) {
        if (_data) {
            ...
            if (Array.isArray(_data["supportedPlatform"])) {
                this.supportedPlatform = [];
                for (let item of _data["supportedPlatform"])
                    this.supportedPlatform.push(item);
            }
    ...
    toJSON(data) {
        ...
        if (Array.isArray(this.supportedPlatform)) {
            data["supportedPlatform"] = [];
            for (let item of this.supportedPlatform)
                data["supportedPlatform"].push(item);
        }
...
class Bots {
    constructor(data) {
        ...
        if (!data) {
            ...
            this.requiresSecurityEnabledGroup = false;
    ...
    init(_data) {
        if (_data) {
            ...
            this.requiresSecurityEnabledGroup = _data["requiresSecurityEnabledGroup"] !== undefined ? _data["requiresSecurityEnabledGroup"] : false;
    ...
    toJSON(data) {
        ...
        data["requiresSecurityEnabledGroup"] = this.requiresSecurityEnabledGroup;
        ...
        if (_data) {
            if (Array.isArray(_data["teams"])) {
                ...
                for (let item of _data["teams"])
                    this.teams.push(Teams.fromJS(item));
            }
            if (Array.isArray(_data["groupChats"])) {
                this.groupChats = [];
                for (let item of _data["groupChats"])
                    this.groupChats.push(GroupChats.fromJS(item));
            }
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
        let result = new ScopeConstraints();
        result.init(data);
        return result;
    }
    toJSON(data) {
        ...
        if (Array.isArray(this.groupChats)) {
            data["groupChats"] = [];
            for (let item of this.groupChats)
                data["groupChats"].push(item.toJSON());
        }
        return data;
    }
}
exports.ScopeConstraints = ScopeConstraints;
var Permissions;
...
})(DevicePermissions = exports.DevicePermissions || (exports.DevicePermissions = {}));
...
})(SupportedChannelTypes = exports.SupportedChannelTypes || (exports.SupportedChannelTypes = {}));
...
})(ConfigurableProperties = exports.ConfigurableProperties || (exports.ConfigurableProperties = {}));
...
})(MosManifestDefaultInstallScope = exports.MosManifestDefaultInstallScope || (exports.MosManifestDefaultInstallScope = {}));
...
class MeetingExtensionDefinition {
    ...
    init(_data) {
        if (_data) {
            ...
            if (Array.isArray(_data["videoFilters"])) {
                this.videoFilters = [];
                for (let item of _data["videoFilters"])
                    this.videoFilters.push(VideoFilters.fromJS(item));
            }
            this.videoFiltersConfigurationUrl = _data["videoFiltersConfigurationUrl"];
    ...
    toJSON(data) {
        ...
        if (Array.isArray(this.videoFilters)) {
            data["videoFilters"] = [];
            for (let item of this.videoFilters)
                data["videoFilters"].push(item.toJSON());
        }
        data["videoFiltersConfigurationUrl"] = this.videoFiltersConfigurationUrl;
...
})(PositionAlign = exports.PositionAlign || (exports.PositionAlign = {}));
...
})(Scopes2 = exports.Scopes2 || (exports.Scopes2 = {}));
var MeetingSurfaces;
(function (MeetingSurfaces) {
    MeetingSurfaces["SidePanel"] = "sidePanel";
    MeetingSurfaces["Stage"] = "stage";
})(MeetingSurfaces = exports.MeetingSurfaces || (exports.MeetingSurfaces = {}));
var Context;
(function (Context) {
...
(function (SupportedPlatform) {
    ...
    SupportedPlatform["TeamsMeetingDevices"] = "teamsMeetingDevices";
...
})(SupportedSharePointHosts = exports.SupportedSharePointHosts || (exports.SupportedSharePointHosts = {}));
var Scopes3;
(function (Scopes3) {
    Scopes3["Team"] = "team";
    Scopes3["Personal"] = "personal";
    Scopes3["GroupChat"] = "groupChat";
})(Scopes3 = exports.Scopes3 || (exports.Scopes3 = {}));
var Context2;
(function (Context2) {
...
})(Context2 = exports.Context2 || (exports.Context2 = {}));
var SupportedPlatform2;
(function (SupportedPlatform2) {
    SupportedPlatform2["Desktop"] = "desktop";
    SupportedPlatform2["Mobile"] = "mobile";
    SupportedPlatform2["TeamsMeetingDevices"] = "teamsMeetingDevices";
})(SupportedPlatform2 = exports.SupportedPlatform2 || (exports.SupportedPlatform2 = {}));
class Configuration {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
})(Scopes4 = exports.Scopes4 || (exports.Scopes4 = {}));
class CommandLists {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
(function (Scopes5) {
    Scopes5["Team"] = "team";
})(Scopes5 = exports.Scopes5 || (exports.Scopes5 = {}));
class Commands {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
})(DefaultGroupCapabilityTeam = exports.DefaultGroupCapabilityTeam || (exports.DefaultGroupCapabilityTeam = {}));
...
})(DefaultGroupCapabilityGroupchat = exports.DefaultGroupCapabilityGroupchat || (exports.DefaultGroupCapabilityGroupchat = {}));
...
})(DefaultGroupCapabilityMeetings = exports.DefaultGroupCapabilityMeetings || (exports.DefaultGroupCapabilityMeetings = {}));
class Scenes {
    constructor(data) {
        if (data) {
            for (var property in data) {
    ...
    init(_data) {
        if (_data) {
            if (Array.isArray(_data["parameters"])) {
                this.parameters = [];
                for (let item of _data["parameters"])
                    this.parameters.push(Parameters2.fromJS(item));
            }
            this.taskInfo = _data["taskInfo"] ? TaskInfo2.fromJS(_data["taskInfo"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
...
})(Scopes6 = exports.Scopes6 || (exports.Scopes6 = {}));
class Commands2 {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
})(CommandsType = exports.CommandsType || (exports.CommandsType = {}));
var Context3;
(function (Context3) {
    Context3["Compose"] = "compose";
    Context3["CommandBox"] = "commandBox";
    Context3["Message"] = "message";
})(Context3 = exports.Context3 || (exports.Context3 = {}));
class Parameters {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
})(MessageHandlersType = exports.MessageHandlersType || (exports.MessageHandlersType = {}));
class Value {
    constructor(data) {
        if (data) {
            for (var property in data) {
        ...
        if (!data) {
            this.supportsAnonymousAccess = false;
    ...
    init(_data) {
        if (_data) {
            ...
            this.supportsAnonymousAccess = _data["supportsAnonymousAccess"] !== undefined ? _data["supportsAnonymousAccess"] : false;
    ...
    toJSON(data) {
        ...
        data["supportsAnonymousAccess"] = this.supportsAnonymousAccess;
...
})(RuntimesType = exports.RuntimesType || (exports.RuntimesType = {}));
class Code {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
})(RuntimesLifetime = exports.RuntimesLifetime || (exports.RuntimesLifetime = {}));
var Contexts;
(function (Contexts) {
...
class Parameters2 {
    constructor(data) {
        ...
        if (!data) {
            this.inputType = Parameters2InputType.Text;
        }
    }
    init(_data) {
        if (_data) {
            this.name = _data["name"];
            this.inputType = _data["inputType"] !== undefined ? _data["inputType"] : Parameters2InputType.Text;
            this.title = _data["title"];
            this.description = _data["description"];
            this.value = _data["value"];
            if (Array.isArray(_data["choices"])) {
                this.choices = [];
                for (let item of _data["choices"])
                    this.choices.push(Choices2.fromJS(item));
            }
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
        let result = new Parameters2();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
exports.Parameters2 = Parameters2;
class TaskInfo2 {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
})(ParametersInputType = exports.ParametersInputType || (exports.ParametersInputType = {}));
class Choices {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
})(ResourceSpecificType = exports.ResourceSpecificType || (exports.ResourceSpecificType = {}));
class Options {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
(function (MenusType) {
    MenusType["Cell"] = "cell";
    MenusType["Text"] = "text";
})(MenusType = exports.MenusType || (exports.MenusType = {}));
class ComAddin {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
var Parameters2InputType;
(function (Parameters2InputType) {
    Parameters2InputType["Text"] = "text";
    Parameters2InputType["Textarea"] = "textarea";
    Parameters2InputType["Number"] = "number";
    Parameters2InputType["Date"] = "date";
    Parameters2InputType["Time"] = "time";
    Parameters2InputType["Toggle"] = "toggle";
    Parameters2InputType["Choiceset"] = "choiceset";
})(Parameters2InputType = exports.Parameters2InputType || (exports.Parameters2InputType = {}));
class Choices2 {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
})(OptionsSendMode = exports.OptionsSendMode || (exports.OptionsSendMode = {}));
